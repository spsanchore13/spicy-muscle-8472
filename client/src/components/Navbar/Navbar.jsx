        ...
        <div className="mainNavbar">
            ...
            <div className="navMid">
                <div className="midLeft">
                    <Link className="homeicon" to="/">BETTERMART</Link>
                    <Link className="homeicon" to="/home2">BETTERLivinghome</Link>
                </div>
                <div className="midRight">
                    <div className="midSearch">
                        <input onKeyDown={handleKeyDown} className="Nav-searchbar" type="text" name="search" placeholder="SEARCH BETTERMART" />
                    </div>
