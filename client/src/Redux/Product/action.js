...
export const getProducts = (params) => (dispatch) => {
  ...
  return axios("https://bettermart.onrender.com/products", params)
    .then((res) => {
...
export const getShoesProducts = () => (dispatch) => {
  // console.log(params)
  dispatch({ type: types.GET_PRODUCTS_REQUEST });
  return axios("https://bettermart.onrender.com/products/shoes")
    .then((res) => {
      dispatch({ type: types.GET_PRODUCTS_SUCCESS, payload: res.data });
    })
    .catch((err) => {
...
export const getDressesProducts = () => (dispatch) => {
  // console.log(params)
  dispatch({ type: types.GET_PRODUCTS_REQUEST });
  return axios("https://bettermart.onrender.com/products/dresses")
    .then((res) => {
      dispatch({ type: types.GET_PRODUCTS_SUCCESS, payload: res.data });
    })
    .catch((err) => {
