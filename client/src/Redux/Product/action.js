...
export const getProducts = (params) => (dispatch) => {
  ...
  return axios("https://pear-brainy-ant.cyclic.app/products", params)
    .then((res) => {
...
export const getShoesProducts = () => (dispatch) => {
  // console.log(params)
  dispatch({ type: types.GET_PRODUCTS_REQUEST });
  return axios("https://pear-brainy-ant.cyclic.app/products/shoes")
    .then((res) => {
      dispatch({ type: types.GET_PRODUCTS_SUCCESS, payload: res.data });
    })
    .catch((err) => {
...
export const getDressesProducts = () => (dispatch) => {
  // console.log(params)
  dispatch({ type: types.GET_PRODUCTS_REQUEST });
  return axios("https://pear-brainy-ant.cyclic.app/products/dresses")
    .then((res) => {
      dispatch({ type: types.GET_PRODUCTS_SUCCESS, payload: res.data });
    })
    .catch((err) => {
...
export const deleteProducts = (id) => (dispatch) => {
  ...
  return axios.delete(`https://pear-brainy-ant.cyclic.app/products/${id}`).then((res) => {
...
export const updateProducts = (id, payload) => (dispatch) => {
  ...
  return axios.patch(`https://pear-brainy-ant.cyclic.app/products/${id}`, payload).then((res) => {
