      ...
      {isSmallerThan ? (
        <Flex textAlign={"left"} justifyContent={"space-between"}>
          <Box>
            ...
            <List spacing={2} mt={"2"}>
              <ListItem>
                <Link href="https://www.anthropologie.com/#order-inquiry">
                  Track Your Order
                </Link>
              </ListItem>
              <ListItem>
              ...
              <ListItem>
                <Link href="https://www.anthropologie.com/help/returns-exchanges">
                  Returns & Exchanges
                </Link>
              </ListItem>
              <ListItem>
                <Link href="https://www.anthropologie.com/help/shipping-info">
                  Shipping
                </Link>
              </ListItem>
              <ListItem>
                <Link href="https://www.anthropologie.com/help/customer-service">
                  Customer Service
                </Link>
              </ListItem>
              <ListItem>
                <Link href="https://www.anthropologie.com/help/current-promotions">
                  Current Promotions
                </Link>
              </ListItem>
              <ListItem>
                <Link href="https://www.anthropologie.com/help/recall">
                  Product Recalls
                </Link>
              </ListItem>
            </List>
          ...
          <Box>
            ...
            <List spacing={2} mt={"2"}>
              <ListItem>
                <Link href="https://www.anthropologie.com/help/our-story">
                  Our Story
                </Link>
              </ListItem>
              <ListItem>
                <Link href="https://anthropologieevents.splashthat.com/">
                  Events
                </Link>
              </ListItem>
              <ListItem>
                <Link href="https://www.anthropologie.com/help/stories-community-greater-good">
                  A Greater Good
                </Link>
              </ListItem>
              <ListItem>
                <Link href="https://www.anthropologie.com/help/diversity-and-inclusion">
                  Diversity & Inclusion
                </Link>
              </ListItem>
              <ListItem>
                <Link href="https://www.anthropologie.com/stories">
                  Stories
                </Link>
              </ListItem>
              <ListItem>
                <Link href="https://www.anthropologie.com/help/klarna">
                  Klarna
                </Link>
              </ListItem>
            </List>
          ...
          <Box>
            ...
            <List spacing={2} mt={"2"}>
              <ListItem>
                <Link href="https://www.anthropologie.com/help/anthro-loyalty">
                  AnthroPerks
                </Link>
              </ListItem>
              <ListItem>
                <Link href="https://www.anthropologie.com/help/gift-card">
                  Gift Cards
                </Link>
              </ListItem>
              <ListItem>
                <Link href="https://www.anthropologie.com/help/design-trade-program">
                  AnthroLiving Designer & Trade Program
                </Link>
              </ListItem>
              <ListItem>
                <Link href="https://www.anthropologie.com/help/furniture-guide">
                  Furniture: Guides & Services
                </Link>
              </ListItem>
              <ListItem>
                <Link href="https://www.anthropologie.com/help/curbside-pick-up">
          ...
          <Box>
            ...
            <List spacing={2} mt={"2"}>
              <ListItem>
                <Link href="https://www.anthropologie.com/help/contact-us">
                  Contact Us
                </Link>
              </ListItem>
              <ListItem>
                <Link href="https://www.anthropologie.com/help/connect-with-us">
                  Stay Connected
                </Link>
              </ListItem>
              <ListItem>
                <Link href="https://www.urbn.com/work-with-us">Careers</Link>
              </ListItem>
              <ListItem>
                <Link href="https://www.anthropologie.com/help/personal-styling">
                  Styling Services
                </Link>
              </ListItem>
              <ListItem>
                <Link href="https://www.anthropologie.com/help/request-catalog">
                  Request A Catalog
                </Link>
              </ListItem>
            </List>
                ...
                <AccordionButton>
                  <Box m={"auto"}>
                    <Flex alignItems={"center"} gap={"7px"} color={"#3289a4"}>
                      <Icon as={CiLocationOn} />
                      <Link href="https://www.anthropologie.com/stores">
                        Store Locator
                      </Link>
                    </Flex>
                  </Box>
              ...
              <h1>
                <AccordionButton>
                  <Box m={"auto"}>
                    <Flex alignItems={"center"} gap={"7px"} color={"#3289a4"}>
                      <Icon as={EmailIcon} />
                      <Link href="https://www.anthropologie.com/#email-sign-up">
                        Email
                      </Link>
                    </Flex>
                  </Box>
